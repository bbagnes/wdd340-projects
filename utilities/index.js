...
"</h4></li>";
grid += "<li><h4>Description:</h4> " + vehicle.inv_description + "</li>";
grid += "<li><h4>Color:</h4> " + vehicle.inv_color + "</li>";
grid +=
"<li><h4>Miles:</h4> " +
...
/* **************************************
* Build a classification selection element for the add vehicle view
* ************************************ */
